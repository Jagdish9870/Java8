...
public class StreamFunctionsTypes {
    ...
    List<Integer> filteredlist= list.stream()
       ...
       List<Integer> mappList= filteredlist.stream()
                                            .map(x->x/2)    
                                            .collect(Collectors.toList());    // map function..........................
    ...
    List<Integer> filteredlist2= list2.stream()
        ...
        List<Integer> filteredlist3= Stream.iterate(0,x->x+1)
                                            .limit(101)
                                            .skip(1)
                                            .filter(x-> x%2 ==0)
                                            .map(x->x/10)
        ...
        Integer filteredlist4= Stream.iterate(0,x->x+1)
                                     .limit(101)
                                     .map(x->x/20)
                                     .distinct()
